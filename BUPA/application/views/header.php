    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="<?= base_url().'Welcome/busia' ?>">Busia County</a></li>
          <li><a class="nav-link scrollto" href="<?= base_url().'Welcome/newsletter' ?>">News Letter</a></li>
